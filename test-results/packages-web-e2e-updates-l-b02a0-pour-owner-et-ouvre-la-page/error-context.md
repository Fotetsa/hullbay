...
- Name: packages/web/e2e/updates.spec.ts >> le badge navbar 'Mises à jour' est présent pour owner et ouvre la page
- Location: packages/web/e2e/updates.spec.ts:138:1
