...
- Name: packages/web/e2e/updates.spec.ts >> le rollback d'une update réussie demande une confirmation avant de partir
- Location: packages/web/e2e/updates.spec.ts:309:1
