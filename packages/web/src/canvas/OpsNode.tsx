...
export type OpsNodeData = {
  ...
  /** If this container is managed by Railpack, show linked repo info */
  railpack?: { repoUrl?: string; branch?: string }
}
    ...
    >
      ...
      <div className="flex items-center gap-1.5">
        ...
        <div className="min-w-0 flex-1">
          ...
          {d.railpack && (
            <div className="mt-0.5 flex items-center gap-1 text-[10px] text-ui-fg-muted">
              ...
              <span title={d.railpack?.repoUrl ?? undefined}>Railpack</span>
            </div>
          )}
